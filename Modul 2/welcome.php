<?php
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($pass)){
            echo "<script>alert('Password belum dimasukkan! 
            Password harus memiliki Huruf kapital, huruf kecil, angka & karakter khusus.')</script>";
            die(" ");
        }
        if($pass<10){
        ...
        } else if($usname && $upperc && $lowerc && $angka && $specialc){
